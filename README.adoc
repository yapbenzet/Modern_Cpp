...
Modern Cpp'ta sınıf oluşturmanın mantığını gösteren örnektir. Sınıfları oluştururken nelere dikkat edilmeli, C++'ta derleme işlemi nasıl yapılır sorularını cevaplamaya yöneliktir. 
